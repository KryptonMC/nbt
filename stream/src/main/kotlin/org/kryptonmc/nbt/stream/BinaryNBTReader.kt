...
public class BinaryNBTReader(private val source: BufferedSource) : NBTReader() {
    ...
    override fun hasNext(): Boolean = !source.exhausted()
    ...
    override fun nextName(): String {
        ...
        val name = source.readUtf8(length.toLong())
        deferredName = name
        return name
    }
    ...
    override fun peekType(): Byte = source.peek().readByte()
    ...
    private fun readNameAndType(type: Int) {
        ...
        if (deferredName == null) {
            ...
            val length = source.readShort()
            deferredName = source.readUtf8(length.toLong())
        }
        deferredName = null
    }
}
