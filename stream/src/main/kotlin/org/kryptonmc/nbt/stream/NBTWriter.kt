...
public interface NBTWriter : Closeable {
    ...
    public companion object {
         ...
         */
        @JvmStatic
        public fun binary(output: OutputStream): NBTWriter {
            val dataOutput = if (output is DataOutputStream) output else DataOutputStream(output)
            return BinaryNBTWriter(dataOutput)
        }
    }
}
