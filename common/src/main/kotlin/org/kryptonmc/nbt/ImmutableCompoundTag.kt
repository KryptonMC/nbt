 ...
 */
public class ImmutableCompoundTag(override val data: PersistentMap<String, Tag>) : ScopedCompoundTag<ImmutableCompoundTag>() {

    override val isImmutable: Boolean
        get() = true

    public constructor() : this(persistentMapOf())
    ...
    override fun toBuilder(): Builder = Builder.immutable(data)
}
