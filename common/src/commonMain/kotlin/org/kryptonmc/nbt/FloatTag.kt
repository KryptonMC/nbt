...
public class FloatTag private constructor(override val value: Float) : NumberTag(value) {
    ...
    public companion object {
        ...
        @JvmField
        public val READER: TagReader<FloatTag> = TagReader { input, _ -> FloatTag(Float.fromBits(input.readInt())) }
        @JvmField
        public val WRITER: TagWriter<FloatTag> = TagWriter { output, value -> output.writeInt(value.value.toBits()) }
